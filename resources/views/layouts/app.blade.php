...
<head>
    ...
    <meta name="keywords" content="software, business, company, bd-top-software-company, e-commerce,pos,govt website,career,retina,retina soft,soft retina">
    <meta name="author" content="Retina Soft">
    <!-- Viewport-->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon and Touch Icons-->
    <link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('images/rs_logo.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('images/rs_logo.png')}}">
  ...
  <body>
    ...
    <main class="page-wrapper">
      <!-- Navbar-->
      <header class="navbar navbar-expand-lg fixed-top" style="background-color:#cdebcb " data-scroll-header>
        <div class="container"><a class="navbar-brand me-0 me-xl-4" href="job-board-home-v1.html"><img class="d-block" src="{{asset('images/rs_logo.png')}}"  alt="Retina Soft" style="width: 200px"></a>
          ...
          <div class="collapse navbar-collapse order-lg-2" id="navbarNav">
            <ul class="navbar-nav navbar-nav-scroll mx-auto" style="max-height: 35rem;">
              <!-- Menu items-->
              <li>
                <a class="nav-item  active"><a class="nav-link " href="{{route('home')}}" role="button" aria-expanded="false">Home</a>
              </li>
              <li>
                <a class="nav-item"><a class="nav-link " href="#" role="button" aria-expanded="false">Product</a>
              </li>
              <li>
                <a class="nav-item"><a class="nav-link " href="#" role="button" aria-expanded="false">About</a>
              </li>
              <li>
                <a class="nav-item"><a class="nav-link " href="#" role="button" aria-expanded="false">Services</a>
              </li>
              <li>
                <a class="nav-item"><a class="nav-link " href="#" role="button" aria-expanded="false">Digital marketing</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <!-- Footer-->
    <footer class="footer pt-5" style="background-color:#cdebcb ">
      <div class="container pb-2">
          ...
          <div class="col-md-6 col-xl-5">
            ...
            <div class="row">
              <div class="col-sm-6 mb-6">
                <h3 class="h6 mb-2 pb-1 fs-base text-dark">Retina Soft</h3>
                <p class="text-justify" style=" text-align: justify;text-justify: inter-word;">We specialize in converting your Vision about your website into Reality. Welcome to <span class="text-primary">Retina Soft</span>, a specialist web design and development agency based in Bangladesh.</p>
              </div>
              <div class="col-sm-6 mb-6">
                <h3 class="h6 mb-2 pb-1 fs-base text-dark">Features</h3>
                <ul class="list-unstyled fs-sm">
                  <li><a class="nav-link-dark" style="text-decoration: none" href="#">Sales Management</a></li>
                  <li><a class="nav-link-dark" style="text-decoration: none" href="#">Contact Management</a></li>
                  <li><a class="nav-link-dark" style="text-decoration: none" href="#">Project Management</a></li>
                  <li><a class="nav-link-dark" style="text-decoration: none" href="#">HR Management</a></li>
                  <li><a class="nav-link-dark" style="text-decoration: none" href="#">Integration & API</a></li>
                  <li><a class="nav-link-dark" style="text-decoration: none" href="#">Gmail & G Suite</a></li>
                </ul>
              </div>
              
            </div>
            <!-- Socials-->
            <div class="text-nowrap border-top border-dark py-4"><a class="btn btn-icon btn-translucent-dark btn-xs rounded-circle me-2" href="#"><i class="fi-facebook"></i></a><a class="btn btn-icon btn-translucent-dark btn-xs rounded-circle me-2" href="#"><i class="fi-twitter"></i></a><a class="btn btn-icon btn-translucent-dark btn-xs rounded-circle me-2" href="#"><i class="fi-messenger"></i></a><a class="btn btn-icon btn-translucent-dark btn-xs rounded-circle me-2" href="#"><i class="fi-telegram"></i></a><a class="btn btn-icon btn-translucent-dark btn-xs rounded-circle" href="#"><i class="fi-whatsapp"></i></a></div>
          </div>
          <!-- Mobile app-->
            ...
            <div class="d-flex align-items-center">
              <div class="card card-light card-body p-4 p-xl-5 my-2 my-md-0" style="max-width: 526px;">
                <div style="max-width: 380px;">
                  <h3 class="h4 text-dark">Download Our App</h3>
                  <p class="fs-sm text-dark opacity-70 mb-2 mb-lg-3">Now finding the new job just got even easier with our new app!</p>
        ...
        <!-- Copyright-->
        <p class="fs-sm text-center text-sm-start mb-4"><span class="text-dark opacity-50">&copy; All rights reserved. Made by </span><a class="nav-link-dark fw-bold" href="https://www.retinasoft.com.bd/" target="_blank" rel="noopener">Retina Soft</a></p>
      </div>
    </footer>
